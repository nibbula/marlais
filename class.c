...
#else
    warning ("Making class name", debug_name, objectclass (obj));
...
#else
  return make_class (obj, supers_obj, slots_obj, abstract_obj, BYTESTRVAL(debug_obj));
#endif
}
