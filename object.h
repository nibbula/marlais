...
enum primtype {
    ...
    prim_0, prim_1, prim_2, prim_3, prim_4,
...
struct object {
    enum objtype type;
#ifdef DEBUG
    /* Where the object was read from, for debugging. */
    char * filename;
    short line;
    short byte;
#endif /* DEBUG */
	...
	struct table table;
	struct deque deque;
	struct array array;				/* @@@ 12 */
	struct condition condition;
	struct symbol symbol;
	struct character character;
	struct class class;				/* @@@ 68 */
	struct instance instance;
	struct singleton singleton;
        struct limited_int_type limited_int_type;	/* @@@ 12 */
	struct union_type union_type;
	struct slot_descriptor slot_descriptor;		/* @@@ 32 */
        struct primitive primitive;			/* @@@ 12 */
	struct generic_function generic_function;	/* @@@ 40 */
	struct method method;				/* @@@ 44 */
	struct next_method next_method;			/* @@@ 16 */
	struct values values;
	struct exitproc exitproc;			/* @@@ 12 */
	struct unwind unwind;
#ifdef NO_COMMON_DYLAN_SPEC
	struct stream stream;
#endif
	struct table_entry table_entry;			/* @@@ 16 */
	struct deque_entry deque_entry;			/* @@@ 12 */
...
/*
** Macros to record line numbers in objects for debugging.
**
** There has got to be a better way than this, but it probably involves a
** signifigant change to the way the parser works.
*/
#ifdef DEBUG
# define OFILENAME(obj)		((obj)->filename)
# define OLINE(obj)		((obj)->line)
# define OBYTE(obj)		((obj)->byte)
# define OSET_FILENAME(obj,f)	((obj)->filename = (f))
# define OSET_LINE(obj,l)	((obj)->line == (l))
# define OSET_BYTE(obj,b)	((obj)->byte == (b))
# define OSET_DEBUG(obj,f,l,b) \
  do { \
    (obj)->filename = f; \
    (obj)->line = l; \
    (obj)->byte = b; \
...
#else /* !DEBUG */
# define OFILENAME(obj)		(0)
# define OLINE(obj)		(0)
# define OBYTE(obj)		(0)
# define OSET_FILENAME(obj,f)	do { } while (0)
# define OSET_LINE(obj,l) 	do { } while (0)
# define OSET_BYTE(obj,b) 	do { } while (0)
# define OSET_DEBUG(obj,f,l,b)	do { } while (0)
#endif /* DEBUG */
...
/* None of this works for small objects */
#define OFILENAME(obj)		(0)
#define OLINE(obj)		(0)
#define OBYTE(obj)		(0)
#define OSET_FILENAME(obj,f)	do { } while (0)
