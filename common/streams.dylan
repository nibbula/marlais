...
//
// $Header: /home/old_pib/dan/bog/cvs/marlais/common/streams.dylan,v 1.1.1.1 2003/07/31 12:13:49 dan Exp $
...
define method stream-position-setter(index, ps :: <positionable-stream>)
  if(index == #"start")
    ps.pos := 0;
  elseif(index == #"end")
...
//------------------------BUFFERED-STREAM-------------------------------
define abstract class <buffered-stream> (<stream>) end;
