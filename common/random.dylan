...
define constant <general-integer> = <integer>; //@@@ bogus
define constant <extended-integer> = <integer>; //@@@ very bogus
...
//
define constant $maximum-integer = #x20000000; // @@@ bogus
...
define sealed class <random-state> (<object>)
  ...
  slot state-seed :: <simple-object-vector>,
    init-value: make(<simple-object-vector>, size: random-max + 1);
...
// @@@ bogus
define method get-time-of-day() => t :: <integer>;
  time();
end method;
