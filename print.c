...
#else /* @@@ use DebugPrint for this */
	{
	  Object sym = escaped ? print_symbol : princ_symbol;
	  Object fun = symbol_value (sym);
...
/* Vaugely Like warning(), but for use in C code (for now).
** Also works when standard-io is not set up.
*/
void
